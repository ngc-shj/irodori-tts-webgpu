...
echo
echo "  # fp16 (optional; faster compute and/or ~half the download) -> artifacts/onnx_fp16/"
echo "  .venv/bin/python export/export_dit_fp16.py        # DiT (special fp16 export)"
echo "  .venv/bin/python export/export_encoders_fp16.py   # text/speaker/duration (half the download)"
echo "  .venv/bin/python export/convert_fp16.py           # dacvae encoder"
